...
/** @description Type declaration for navigation action */
...
/** @internal  Factory function for navigate handler */
export type NavigateHandlerFactory = (injector: Injector) => NavigateHandler;

/** @description URL changes observable listener */
export type UrlChanges = Observable<{ previous: string | null; next: string }>;

/** @internal  Provides a factory function for url changes */
